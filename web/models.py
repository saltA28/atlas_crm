...
class Food(models.Model):
    ...
    餐馆 管理
    """
    title = models.CharField(verbose_name='客户名称', max_length=32)
    money = models.CharField(verbose_name='累计消费', max_length=32)
...
class Product(models.Model):
    ...
    产品 管理
    """
    title = models.CharField(verbose_name='产品名', max_length=32)
    money = models.CharField(verbose_name='售价', max_length=32)
    time = models.CharField(verbose_name='使用时长', max_length=64)
...
class Sale(models.Model):
    ...
    """
    title = models.CharField(verbose_name='产品名', max_length=32)
    company = models.CharField(verbose_name='企业名', max_length=32)
    money = models.CharField(verbose_name='金额', max_length=32)
    time_limit = models.CharField(verbose_name='使用期限', max_length=64)
